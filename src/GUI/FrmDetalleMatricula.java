...
public class FrmDetalleMatricula extends JFrame implements ActionListener, MouseListener {
    ...
    private static FrmDetalleMatricula unicainstancia;

    public static FrmDetalleMatricula getInstancia() {
        if (unicainstancia == null) {
            unicainstancia = new FrmDetalleMatricula();
        }
        return unicainstancia;
    }

    private JLabel lbltitulo, LBLMATRICULA, LBLCURSO, lblregistrodm;
    ...
    public void GUI() {
        ...
        try {
            ...
            lblregistrodm = new JLabel();
            getContentPane().add(lblregistrodm);
            lblregistrodm.setText("DETALLE MATRICULA");
            lblregistrodm.setBounds(200, 40, 157, 23);
