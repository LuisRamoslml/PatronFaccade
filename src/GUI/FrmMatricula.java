...
public class FrmMatricula extends JFrame implements ActionListener, MouseListener {
    ...
    private static FrmMatricula unicainstancia;

    public static FrmMatricula getInstancia() {
        if (unicainstancia == null) {
            unicainstancia = new FrmMatricula();
        }
        return unicainstancia;
    }

    private JLabel lbltitulo, lblid, lblseccion, lblgrado, lblalumno, lblregistrom;
    ...
    public static JLabel lblSecretaria;
    ...
    public void GUI() {
        ...
        try {
            ...
            lblregistrom = new JLabel();
            getContentPane().add(lblregistrom);
            lblregistrom.setText("REGISTRAR MATRICULA");
            lblregistrom.setBounds(200, 40, 157, 23);
            ...
            getContentPane().add(lblSecretaria);
            lblSecretaria.setVisible(false);
    ...
    public void grabarmatricula() {
        ...
        objbean1.setIdsecretaria(Integer.parseInt(lblSecretaria.getText()));
        objfachada = new Fachada();
