...
public class FrmProfesor extends JFrame implements ActionListener, MouseListener {
    ...
    private static FrmProfesor unicainstancia;

    public static FrmProfesor getInstancia() {
        if (unicainstancia == null) {
            unicainstancia = new FrmProfesor();
        }
        return unicainstancia;
    }

    private JLabel lblcodprofesor, lblnombres, lbldni, lblcorreo, lbltelefono, lbldireccion, lblresultado, lblestado,lblregistro;
    ...
    public void GUI() {
        ...
        try {
            ...
            lblregistro.setText("REGISTRAR PROFESOR");
            lblregistro.setBounds(250, 40, 157, 23);
