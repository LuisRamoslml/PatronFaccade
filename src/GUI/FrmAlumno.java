...
public class FrmAlumno extends JFrame implements MouseListener, ActionListener {
    ...
    private static FrmAlumno unicainstancia;

    public static FrmAlumno getInstancia() {
        if (unicainstancia == null) {
            unicainstancia = new FrmAlumno();
        }
        return unicainstancia;
    }

    private JLabel lblidalumno, lblnombre, lbldni, lblcorreo, lbltelefono, lbldireccion, lblestado, lbltitulo ,lblregistroa;
    ...
    public void GUI() {
        ...
        try {
            ...
            lblregistroa = new JLabel();
            getContentPane().add(lblregistroa);
            lblregistroa.setText("REGISTRAR HORARIO");
            lblregistroa.setBounds(400, 40, 157, 23);
