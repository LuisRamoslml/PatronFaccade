...
public class FrmCurso extends JFrame implements ActionListener, MouseListener {
    ...
    private static FrmCurso unicainstancia;

    public static FrmCurso getInstancia() {
        if (unicainstancia == null) {
            unicainstancia = new FrmCurso();
        }
        return unicainstancia;
    }

    private JLabel lblCodigo, lblNombre, lblregistroc;
    ...
    private void initGUI() {
        ...
        try {
            ...
            lblregistroc = new JLabel();
            getContentPane().add(lblregistroc);
            lblregistroc.setText("REGISTRAR CURSO");
            lblregistroc.setBounds(250, 10, 157, 23);
