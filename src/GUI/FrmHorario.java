...
public class FrmHorario extends JFrame implements ActionListener, MouseListener {
    ...
    private static FrmHorario unicainstancia;

    public static FrmHorario getInstancia() {
        if (unicainstancia == null) {
            unicainstancia = new FrmHorario();
        }
        return unicainstancia;
    }

    private JLabel lblCodigo, lblDia, lblHoraInicio, lblHoraFin, lblSeccion, lblAula, lblProfesor, lblCurso, lblregistroh;
    ...
    private void initGUI() {
        ...
        try {
            ...
            lblregistroh = new JLabel();
            getContentPane().add(lblregistroh);
            lblregistroh.setText("REGISTRAR HORARIO");
            lblregistroh.setBounds(250, 20, 157, 23);
